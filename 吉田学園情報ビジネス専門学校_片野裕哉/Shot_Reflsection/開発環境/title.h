...
#define TITLE_LOGOSHADOW_COLOR (D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f))	// ロゴ影色(赤, 緑, 青, 透明度)

#define TITLE_LOGO_COLOR (D3DXCOLOR(0.0f, 0.66f, 1.0f, 1.0f))		// ロゴ色(赤, 緑, 青, 透明度)

#define ENTER_SIGN_COLOR_OFF (D3DXCOLOR(1.0f, 1.0f, 1.0f, 0.0f))		// エンターサインOFF色(赤, 緑, 青, 透明度)
#define ENTER_SIGN_COLOR_ON (D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f))		// エンターサインON色(赤, 緑, 青, 透明度)

#define MAX_TYPE_TITLE (4)
#define TITLE_BG_SIZE_X (1920.0f)
#define TITLE_BG_SIZE_Y (1080.0f)
#define TITLE_LOGOB_SIZE_X (530.75f)
#define TITLE_LOGOB_SIZE_Y (267.0f)
