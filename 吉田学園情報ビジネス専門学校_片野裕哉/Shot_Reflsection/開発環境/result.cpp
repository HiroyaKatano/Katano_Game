...
HRESULT InitResult(void)
{
	...
	// テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\GameOver000.png", &g_apTextureResult[0]);
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\GameClear000.png", &g_apTextureResult[1]);
	...
	// 頂点座標の設定
	pVtex[0].pos = D3DXVECTOR3(0.0f, SCREEN_HEIGTH, 0.0f);
	pVtex[1].pos = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
	pVtex[2].pos = D3DXVECTOR3(SCREEN_WIDTH, SCREEN_HEIGTH, 0.0f);
	pVtex[3].pos = D3DXVECTOR3(SCREEN_WIDTH, 0.0f, 0.0f);
