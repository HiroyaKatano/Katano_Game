...
HRESULT InitTutorial(void)
{
	...
	if (FAILED(pDevice->CreateVertexBuffer(
		sizeof(VERTEX_2D) * VTX_NUM * MAX_TUTORIAL_TYPE,
		D3DUSAGE_WRITEONLY,
		FVF_VERTEX_2D,
		D3DPOOL_MANAGED,
		&g_pVtxBuffTutorial,
	...
	// 頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(TUTORIAL_POS_LEFT_X, TUTORIAL_POS_UNDER_Y, Z_AXIS_ZERO);
	pVtx[1].pos = D3DXVECTOR3(TUTORIAL_POS_LEFT_X, TUTORIAL_POS_TOP_Y, Z_AXIS_ZERO);
	pVtx[2].pos = D3DXVECTOR3(TUTORIAL_POS_RIGHT_X, TUTORIAL_POS_UNDER_Y, Z_AXIS_ZERO);
	pVtx[3].pos = D3DXVECTOR3(TUTORIAL_POS_RIGHT_X, TUTORIAL_POS_TOP_Y, Z_AXIS_ZERO);
