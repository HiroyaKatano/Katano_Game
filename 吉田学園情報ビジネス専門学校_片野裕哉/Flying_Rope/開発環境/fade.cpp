...
HRESULT InitFade(MODE modeNext)
{
	...
	// 頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(SCREEN_WIDTH_L, SCREEN_HEIGHT_U, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(SCREEN_WIDTH_L, SCREEN_HEIGHT_T, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(SCREEN_WIDTH_R, SCREEN_HEIGHT_U, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(SCREEN_WIDTH_R, SCREEN_HEIGHT_T, 0.0f);
