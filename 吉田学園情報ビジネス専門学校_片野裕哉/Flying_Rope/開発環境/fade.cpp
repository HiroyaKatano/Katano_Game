...
HRESULT InitFade(MODE modeNext)
{
	...
	// 頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(SCREEN_WIDTH_L, SCREEN_HEIGHT_U, Z_AXIS_ZERO);
	pVtx[1].pos = D3DXVECTOR3(SCREEN_WIDTH_L, SCREEN_HEIGHT_T, Z_AXIS_ZERO);
	pVtx[2].pos = D3DXVECTOR3(SCREEN_WIDTH_R, SCREEN_HEIGHT_U, Z_AXIS_ZERO);
	pVtx[3].pos = D3DXVECTOR3(SCREEN_WIDTH_R, SCREEN_HEIGHT_T, Z_AXIS_ZERO);
