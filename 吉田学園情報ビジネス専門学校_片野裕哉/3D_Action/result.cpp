...
// マクロ定義
//=========================================================================================================================
#define MAX_TYPE_RESULT (1)

//=========================================================================================================================
// グローバル変数
//=========================================================================================================================
LPDIRECT3DVERTEXBUFFER9 g_pVtxBuffResult = NULL;				// 頂点バッファ
LPDIRECT3DTEXTURE9 g_apTextureResult[MAX_TYPE_RESULT] = {};		// テクスチャ
...
HRESULT InitResult(void)
{
	...
	// テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\title_bg.jpg", &g_apTextureResult[0]);
	...
	// 頂点座標の設定
	pVtex[0].pos = D3DXVECTOR3(0.0f, SCREEN_HEIGHT, 0.0f);
	pVtex[1].pos = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
	pVtex[2].pos = D3DXVECTOR3(SCREEN_WIDTH, SCREEN_HEIGHT, 0.0f);
